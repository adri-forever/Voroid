...
$\Leftrightarrow t(a_y-b_y)^2 + \frac{(a_x+b_x)(a_y-b_y)}{2} - c_x(a_y - b_y) + t(b_x-a_x)^2 + \frac{(a_y+b_y)(b_x-a_x)}{2} - c_y(b_x - a_x) = 0$\\
$\Leftrightarrow t((a_y-b_y)^2 + (b_x-a_x)^2) + \frac{(a_x+b_x)(a_y-b_y)}{2} - c_x(a_y - b_y) + \frac{(a_y+b_y)(b_x-a_x)}{2} - c_y(b_x - a_x) = 0$\\
$\Leftrightarrow t((a_y-b_y)^2 + (b_x-a_x)^2) = -\frac{(a_x+b_x)(a_y-b_y)}{2} + c_x(a_y - b_y) - \frac{(a_y+b_y)(b_x-a_x)}{2} + c_y(b_x - a_x)$\\
$\Leftrightarrow t = \frac{c_x(a_y - b_y) + c_y(b_x - a_x) - \frac{(a_x+b_x)(a_y-b_y)-(a_y+b_y)(b_x-a_x)}{2}}{(a_y-b_y)^2 + (b_x-a_x)^2}$\\
$\Leftrightarrow t = \frac{c_x(a_y - b_y) + c_y(b_x - a_x) - \frac{a_xa_y - a_xb_y + b_xa_y - b_xb_y +a_ya_x-a_yb_x+b_ya_x-b_yb_x}{2}}{(a_y-b_y)^2 + (b_x-a_x)^2}$\\
$\Leftrightarrow t = \frac{c_x(a_y - b_y) + c_y(b_x - a_x) - a_xa_y + b_xb_y}{(a_y-b_y)^2 + (b_x-a_x)^2}$\\
